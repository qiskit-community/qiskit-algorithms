...
SOURCE_REPOSITORY="git@github.com:Qiskit/qiskit-algorithms.git"
SOURCE_DIR=`pwd`
SOURCE_LANG='en'
...
git rm -rf --ignore-unmatch algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/*.po \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/api \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/apidocs \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/stubs \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/release_notes.po \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/theme \
    algorithms/$DOC_DIR_PO/$SOURCE_LANG/LC_MESSAGES/_*
...
echo "copy directory"
cp -r $SOURCE_DIR/$DOC_DIR_PO/algorithms/docs
cp $SOURCE_DIR/setup.py algorithms/.
cp $SOURCE_DIR/requirements-dev.txt algorithms/.
cp $SOURCE_DIR/requirements.txt algorithms/.
cp $SOURCE_DIR/README.md algorithms/.
cp $SOURCE_DIR/qiskit_algorithms/VERSION.txt algorithms/qiskit_algorithms/.
...
git commit -m "[Qiskit Algorithms] Automated documentation update to add .po files" -m "skip ci" -m "Commit: $GITHUB_SHA" -m "Github Actions Run: https://github.com/Qiskit/qiskit/runs/$GITHUB_RUN_NUMBER"
echo "git push"
